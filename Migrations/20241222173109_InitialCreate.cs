        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FuelConsume = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "(CURRENT_TIMESTAMP + '2 days'::interval)"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("OrderProduct_pkey", x => x.OrderProductID);
                    table.ForeignKey(
